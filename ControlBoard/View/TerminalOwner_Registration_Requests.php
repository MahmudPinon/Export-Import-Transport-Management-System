...
include '../Controller/ReturnTerminalOwnerRegReqController.php';
$res=reqtermnlresreturn();
// if(empty($res))
//         {
//             echo "No Request";
//         }
...
<form action="../Controller/TerminalOwnerApprovalController.php" method="POST">
...
{
    foreach ($res as $row) {
        if($row['Control Panel Approval(Yes/No)'] == NULL && $row['User Type'] == "terminalowner") {
?>
