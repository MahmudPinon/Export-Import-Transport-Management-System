...
<h3>Profile</h3>
    ...
    <table bgcolor="black" width="1200" align="center">
		...
		<td><a href="TransportOwner_View_Profile.php?id=<?php echo $student['Serial Number'] ?>"><?php echo $student['Name'] ?></a></td>
		...
		<td><a href="TransportOwner_EditProfile.html?id=<?php echo $student['Serial Number'] ?>">Edit</a></td>
        </tr>
    </table>
</br>
</br>
</br>
     <div style="text-align:center;"><a href="../View/TranspoertWonerWorkstart.php" style="display:inline-block; padding:10px 20px; border:1px solid blue; color:blue; text-decoration:none;">Home</a></div>;
